...
const createBookItemsHtml = () => {
    ...
    bookList.forEach ((book, index) => {
        ...
        <div class="row book-card">
            ...
            <div class="col-6 d-flex justfy-content-between flex-column">
                ...
                <div>
                    <spaan class="black fw-bold fs-4 me-2">${book.price}₺</spaan>
                    ${
                        book.oldPrice  
                        ? `<spaan class="fs-4 fw-bold old-price">${book.oldPrice}₺</spaan>` 
                        : ""
                    } 
...
const listBasketItems = () =>{
    ...
    basketListEl.innerHTML = basketListHtml ? basketListHtml : `<li class="basket-item">
